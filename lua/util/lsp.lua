...
M.on_attach = function(_, bufnr)
  ...
  mapkey("<leader>xD", "Lspsaga show_line_diagnostics", { buffer = bufnr, desc = "Line Diagnostics" })
  mapkey("<leader>xd", "Lspsaga show_cursor_diagnostics", { buffer = bufnr, desc = "Cursor Diagnostics" })
  mapkey("<leader>xp", "Lspsaga diagnostic_jump_prev", { buffer = bufnr, desc = "Previous Diagnostic" })
